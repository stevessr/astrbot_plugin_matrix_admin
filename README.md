...
**用法**：
```text
/admin scanqr <user_id> <device_id> <二维码图片路径或base64载荷> [matrix_platform_id]
```
...
**用法**：
```text
/admin matrixstatus [matrix_platform_id]
```
...
**用法**：
```text
/admin reconnect [matrix_platform_id]
```
...
**用法**：
```text
/admin resendpending [matrix_platform_id] [limit]
```
