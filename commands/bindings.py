"""
Matrix Admin Plugin - Command bindings
Expose command group and register command handlers.
"""

from astrbot.api.event import AstrMessageEvent, filter


class AdminCommandBindingsMixin:
    """Register /admin command group and wrappers."""
